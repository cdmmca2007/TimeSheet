!function() {
    ...
    function r(n) {
        return {
            left: function(t, r, e, u) {
                for (arguments.length < 3 && (e = 0), arguments.length < 4 && (u = t.length);
                u > e;
                ) {
                    var i = e + u>>>1;
                    n(t[i], r) < 0 ? e = i + 1 : u = i
    ...
    function C(n, t) {
        ...
        function e() {
            for (var r =- 1, e = t.apply(this, arguments);
            ++r < u;
            )n[r](this, e)
        }
        n = A(n).map(N);
    ...
    function Nt(n, t, r, e) {
        ...
        return !Qo.XDomainRequest || "withCredentials"in c ||!/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest), "onload"in c ? c.onload = c.onerror = u : c.onreadystatechange = function() {
            ...
            if (2 === arguments.length && "function" == typeof e && (u = e, e = null), c.open(r, n, !0)
                , null == t || "accept"in a || (a.accept = t + ",*/*"), c.setRequestHeader)for (var l in a)
    ...
    function Pt(n) {
        ...
        return function(n) {
            ...
            switch (h && (h =+ h.substring(1)), (s || "0" === e && "=" === o) && (s = e = "0", o = "=", f && (l -= Math.floor((l-1) / 4))),
            g) {
            case"n":
                f=!0, g = "g";
                break;
        ...
        function r(n, t, r, e) {
            for (var u, i, o, a = 0, c = t.length, s = r.length; c > a;) {
                ...
                if (u = t.charCodeAt(a++), 37 === u) {
                    if (o = t.charAt(a++), i = N[o in ic ? t.charAt(a++) 
                        : o], !i || (e = i(n, r, e)) < 0)return -1
        ...
        function r(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!r && (s = c = v) && n.lineStart(), v !== c && (g = e(r, p)
                        , (_r(r, g) || _r(p, g)) && (p[0] += Ca, p[1] += Ca, v = t(p[0], p[1]))), v !== c)l = 0, v ? (n.lineStart(), g = e(p, r), n.point(g[0], g[1])) : (g = e(r, p), n.point(g[0], g[1]), n.lineEnd()), r = g;
                    else if (a && r && o^v) {
                        var m;
    ...
    function iu(n, t) {
        ...
        )if (u = Jc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))(i.x !== r || i.y !== e) && (Xc[i.i] = new Oe(i), je(i), r = i.x, e = i.y)
            , i = n.pop();
        else {
            if (!u)
                break;
    ...
    function Hu(n, t) {
        ...
        return a[0] != c[0] || a[1] != c[1] ? (e.push("translate(", null, ",", null, ")"), u.push({
            ...
            i : e.push(e.pop() + "rotate(", null, ")")-2, x : pu(s, l)
    ...
    function yi(n) {
        ...
        if ((r = n.children) && (s = r.length)) {
            ...
            if (r.forEach(xi), e = r[0], e.x =- e.r, e.y = 0, t(e)
                , s > 1 && (u = r[1], u.x = u.r, u.y = 0, t(u), s > 2))for (i = r[2], bi(e, u, i)
                , t(i), vi(e, i), e._pack_prev = i, vi(i, u), u = e._pack_next, o = 3;
            s > o;
            o++) {
                bi(e, u, i = r[o]);
                var p = 0, v = 1, d = 1;
    ...
    function ao(n) {
        function t(t) {
            ...
            for (var c, s = [], l = [], f =- 1, h = t.length, g = Et(r)
                , p = Et(e);
            ++f < h;
    ...
    function Eo(n) {
        for (var t = 0, r = n.length-1, e = [], u = n[0], i = n[1], o = e[0] = ko(u, i);
        ++t < r;
    ...
    function zo(n) {
        function t(t) {
            ...
            for (var h, g, p, v = [], d = [], m = [], y =- 1, x = t.length, M = Et(r)
                , _ = Et(u), b = r === e ? function() {
                return g
            } : Et(e), w = u === i ? function() {
                return p
            } : Et(i);
    ...
    Bo.bisectLeft = aa.left, Bo.bisect = Bo.bisectRight = aa.right, Bo.bisector = function(t) {
        ...
        for (var t, r = 0, e = n.length-1, u = n[0], i = new Array(0 > e ? 0 : e);
        e > r;
        )i[r] = [t = u, u = n[++r]];
        return i
    }, Bo.zip = function() {
        if (!(u = arguments.length))
            return [];
        for (var n =- 1, t = Bo.min(arguments, e)
            , r = new Array(t);
        ++n < t;
    ...
    Bo.dispatch = function() {
        ...
        var r = n.indexOf("."), e = "";
        if (r >= 0 && (e = n.substring(r + 1), n = n.substring(0, r))
            , n)return arguments.length < 2 ? this[n].on(e) : this[n].on(e, t);
    ...
    ya.select = function(n) {
        ...
        for (var o =- 1, a = this.length; ++o < a;) {
            ...
            for (var c =- 1, s = e.length; ++c < s;)(u = e[c]) 
    ...
    Bo.selection.enter = U, Bo.selection.enter.prototype = Ma, Ma.append = ya.append, Ma.empty = ya.empty, Ma.node = ya.node, Ma.call = ya.call, Ma.size = ya.size, Ma.select = function(n) {
        for (var t, r, e, u, i, o = [], a =- 1, c = this.length; ++a < c;) {
            ...
            for (var s =- 1, l = u.length; ++s < l;)(i = u[s]) 
                ? (t.push(e[s] = r = n.call(u.parentNode, i.__data__, s, a)), r.__data__ = i.__data__) : t.push(null)
        }
        return _(o)
    ...
    $a.forEach(function(n, t) {
        ...
        if (arguments.length < 3 && (r = t, t = x().changedTouches)
            , t)for (var e, u = 0, i = t.length; i > u; ++u)
    ...
    Vc.area = function() {
        ...
        for (var t, r, e, u, i, o, a = qe(n), c =- 1, s = this.length - qe(this)
            , l = this[s-1];
        ++c < s;
        ) {
            for (t = n.slice(), n.length = 0, u = this[c], i = t[(e = t.length - a)
                -1], r =- 1;
            ++r < e;
    ...
    Oe.prototype.prepare = function() {
        ...
        remove: function(n) {
            ...
            if (r = i ? o ? uu(o) : i : o, u ? u.L === n ? u.L = r : u.R = r : this._ = r, i && o ? (e = r.C, r.C = n.C, r.L = i, i.U = r, r !== o ? (u = r.U, r.U = n.U, n = r.R, u.L = n, r.R = o, o.U = r) 
                : (r.U = u, u = r, n = r.R)) : (e = n.C, n = r), n && (n.U = u), !e) {
                if (n && n.C)
                    return n.C=!1, void 0;
                do {
                    if (n === this._)
    ...
    Bo.interpolateTransform = Hu, Bo.layout = {}, Bo.layout.bundle = function() {
        ...
        return a.tick = function() {
            ...
            if (g)
                for (Ju(t = Bo.geom.quadtree(m), e, o)
                    , r =- 1;
            ++r < _;
    ...
    Bo.layout.hierarchy = function() {
        function n(u) {
            ...
            for (u.depth = 0; null != (i = o.pop());)
                if (a.push(i), (s = r.call(n, i, i.depth)
                    ) && (c = s.length)) {
                for (var c, s, l; --c >= 0;)
        ...
        wiggle: function(n) {
            ...
            for (g[0] = c = s = 0, r = 1; h > r; ++r) {
                ...
                for (t = 0, i = 0, a = f[r][0] - f[r-1][0]; l > t; ++t) {
                    for (e = 0, o = (n[t][r][1] - n[t][r-1][1]) 
                        / (2 * a);
                    t > e;
                    ++e)o += (n[e][r][1] - n[e][r-1][1]) / a;
                    i += o * n[t][r][1]
                }
    ...
    Bo.layout.histogram = function() {
        ...
        function n(n, u) {
            ...
            if (Ku(h, r), h.parent.m =- h.z, Gu(h, e)
                , s)Gu(f, i);
            else {
                var g = f, p = f, v = f;
                Gu(f, function(n) {
        ...
        function u(n, t, r) {
            if (t) {
                for (var e, u = n, i = n, o = t, c = u.parent.children[0], s = u.m, l = i.m, f = o.m, h = c.m; o = ki(o), u = Si(u)
                    , o && u;
    ...
    Ls.call = ya.call, Ls.empty = ya.empty, Ls.node = ya.node, Ls.size = ya.size, Bo.transition = function(n) {
        ...
        for (var o =- 1, a = this.length; ++o < a;) {
            i.push(t = []);
            for (var c = this[o], s =- 1, l = c.length; ++s < l;)(e = c[s]) 
                && (r = n.call(e, e.__data__, s, o)) ? ("__data__"in e && (r.__data__ = e.__data__), Fo(r, s, u, e.__transition__[u]), t.push(r)) : t.push(null)
        }
        return Uo(i, u)
        ...
        for (var n, t, r, e, u = this.id, i=++Ts, o = [], a = 0, c = this.length; c > a; a++) {
            o.push(n = []);
            for (var t = this[a], s = 0, l = t.length; l > s; s++)(r = t[s]) 
                && (e = Object.create(r.__transition__[u]), e.delay += e.duration, Fo(r, s, i, e)), n.push(r)
        }
        return Uo(o, i)
    ...
    Bo.svg.brush = function() {
        ...
        function u() {
            ...
            if (Bo.event.changedTouches ? L.on("touchmove.brush", v).on("touchend.brush", m) : L.on("mousemove.brush", v).on("mouseup.brush", m), S.interrupt().selectAll("*").interrupt()
                , C)z[0] = l[0] - z[0], z[1] = f[0] - z[1];
            else if (k) {
